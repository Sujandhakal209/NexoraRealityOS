...
export const TEMPLATES = [
  ...
  },
  {
    ...
    category: "Broker",
    features: ["Personal brand showcase", "Featured property highlights", "Direct WhatsApp and call buttons"],
    gradient: "from-[#faf7f0] to-[#dce9e0]",
    available: false,
  },
  {
    id: "land-developer",
    ...
    category: "Land Developer",
    features: ["Interactive plot map layout", "Project phase tracking", "Site visit booking forms"],
    gradient: "from-[#e3f0f8] to-[#cbded8]",
    available: false,
  },
  {
    id: "housing",
    ...
    category: "Housing Project",
    features: ["Unit type showcase", "High-conversion booking forms", "Project gallery and amenities"],
    gradient: "from-[#f3ede3] to-[#d9e4df]",
    available: false,
  },
  {
    id: "rental",
    ...
    category: "Rental",
    features: ["Rental listing filters", "Availability status display", "Tenant inquiry forms"],
