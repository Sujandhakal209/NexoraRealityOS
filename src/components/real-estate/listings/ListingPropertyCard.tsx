...
import type { ListingProperty } from "@/lib/real-estate-template";
...
export function ListingPropertyCard({
  ...
  return (
    <article className="card-hover overflow-hidden rounded-[var(--radius-card)] border border-light-border bg-surface-container-lowest shadow-low">
      ...
      <div className="p-5">
        ...
        <h3 className="mt-2 text-lg font-semibold leading-7 text-on-surface">
          {property.title}
        </h3>
